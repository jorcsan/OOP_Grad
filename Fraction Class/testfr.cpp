...
public:
	...
	{
		Fraction temp;
		temp.setNum(this->num * other.num);
		temp.setDen(this->den * other.den);
		temp.simplify();
		return temp;
	}
	Fraction operator*(int a)
...
int main() {
	...
	Fraction f1(1, 2);
	Fraction f2(2, 3);
	Fraction result = f1 + f2;  // 1/2 + 2/3 = 7/6
	cout << result << endl;     // Output should be "7/6"

	result = 3 - f2;  // 3 - 2/3 = 7/3
	cout << result << endl;     // Output should be "7/3"
